...
<body style="margin: 15px;">
    ...
    <div class="d-flex justify-content-around"><h5>UPSTREAM BILL LIST</h5> </div> 
    <div class="d-flex justify-content-around"><h5><a href="upstream_bill_add.php">Add Bill</a></h5> </div> 
    <?php 
