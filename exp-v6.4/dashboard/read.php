...
if (!empty($jwt)) {
    ...
    try {
        ...
        $current_month_total_service = $dashboard->current_month_total_service();
        $current_month_total_bill = $dashboard->current_month_total_bill();
        ...
        echo json_encode(
            array(
                ...
                "current_month_total_service" => $current_month_total_service,
                "current_month_total_bill" => $current_month_total_bill,
            )
        );
    } catch (\Throwable $th) {
