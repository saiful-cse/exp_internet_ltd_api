...
if (isset($_POST['view'])) {
    if (empty($_POST['first_date'])) {
        ...
        $api = "http://creativesaif.com/api/exp-v3.3/txn/all_txn.php?" . "first_date=" . $first_date . "&last_date=" . $last_date;
...
<body>
    ...
    <div id="company_header">
        ...
        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
            <input type="date" name="first_date" value="<?php echo $_POST['first_date'] ?>"> <span>To</span>
            <input type="date" name="last_date" value="<?php echo $_POST['last_date'] ?>">
        ...
        <?php if (is_array($getTxn['all_txn'])) {
            foreach ($getTxn['all_txn'] as $eachTxn) { ?>
                <tr>
                    ...
                    <td><?php echo $eachTxn['userid']; ?></td>
                    <td><?php echo $eachTxn['method']; ?></td>
